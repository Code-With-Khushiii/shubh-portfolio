...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-50/95 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-2xl font-bold text-slate-900 tracking-tight">SHUBH KAMDAR</div>
      ...
      {/* Hero Section */}
      <section id="hero" className="pt-32 pb-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6 tracking-tight">
              SHUBH KAMDAR
            </h1>
            <div className="text-lg text-slate-600 mb-2 font-medium tracking-wide">
              Data Analyst | Business Analytics & BI
            </div>
            <div className="text-sm uppercase tracking-[0.2em] text-slate-500 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button 
                ...
                className="bg-slate-900 text-white px-10 py-4 font-medium tracking-wide hover:bg-slate-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 rounded-lg"
              >
                📊 VIEW EXPERIENCE
              </button>
              <button 
                onClick={() => scrollToSection('contact')}
                className="border-2 border-slate-900 text-slate-900 px-10 py-4 font-medium tracking-wide hover:bg-slate-900 hover:text-white transition-all duration-300 rounded-lg"
              >
                📬 CONTACT
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16 text-center">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
                <div className="text-xs tracking-widest text-slate-500 mb-2">{stat.label}</div>
                <div className="text-3xl font-bold text-slate-900 mb-1">{stat.value}</div>
                <div className="text-sm text-slate-600 font-medium">{stat.detail}</div>
              </div>
            ))}
          </div>
          <div className="text-center mt-12">
            <ChevronDown 
              className="w-6 h-6 text-slate-400 mx-auto animate-bounce cursor-pointer hover:text-slate-900 transition-colors"
      ...
      <section id="summary" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-slate-900 mb-8 tracking-tight">SUMMARY</h2>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div key={index} className="bg-slate-50 p-8 rounded-lg shadow-sm border border-slate-200 text-center hover:shadow-md transition-shadow">
                <div className="w-14 h-14 bg-blue-600 mx-auto mb-6 flex items-center justify-center rounded-full">
                  <card.icon className="w-7 h-7 text-white" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-4">{card.title.toUpperCase()}</h3>
                <p className="text-slate-600 leading-relaxed">{card.detail}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="experience" className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-slate-900 mb-8 tracking-tight">WORK EXPERIENCE</h2>
          ...
          <div className="space-y-10">
            {experience.map((role, index) => (
              <div key={index} className="bg-white p-8 rounded-lg shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900">{role.role}</h3>
                    <p className="text-blue-600 font-semibold">{role.company}</p>
                  </div>
                  <div className="text-sm text-slate-500 font-medium mt-2 md:mt-0">
      ...
      <section id="projects" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-slate-900 mb-8 tracking-tight">PROJECTS</h2>
            <div className="w-16 h-1 bg-blue-600 mx-auto mb-8"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div 
                key={index}
                className="bg-slate-50 p-6 rounded-lg hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1 border border-slate-200"
                onClick={() => setSelectedProject(index)}
              >
                <div className="mb-3">
                  <span className="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full tracking-wide">
                    {project.category}
                  </span>
                </div>
                ...
                <div className="mt-4 flex items-center text-blue-600 hover:text-blue-800 transition-colors font-medium">
      ...
      {selectedProject !== null && (
        <div className="fixed inset-0 bg-slate-900/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white max-w-4xl max-h-[90vh] overflow-y-auto rounded-lg shadow-2xl">
            ...
            <div className="p-6 space-y-8">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-3">INTRODUCTION</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-3">PROBLEM STATEMENT</h3>
                <p className="text-slate-600 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-3">METHODOLOGY</h3>
      ...
      <section id="skills" className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-slate-900 mb-8 tracking-tight">SKILLS</h2>
            <div className="w-16 h-1 bg-blue-600 mx-auto mb-8"></div>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {skillCategories.map((category, index) => (
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-blue-600 mx-auto mb-8 flex items-center justify-center rounded-full">
                  <category.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-lg font-bold text-slate-900 mb-6">{category.title.toUpperCase()}</h3>
                <ul className="space-y-3">
                  {category.skills.map((skill, skillIndex) => (
                    <li key={skillIndex} className="text-sm text-slate-600 font-medium">
                      {skill}
                    </li>
                  ))}
                </ul>
      ...
      <section id="certifications" className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-8 tracking-tight">CERTIFICATIONS</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {certifications.map((cert, index) => (
              <div key={index} className="flex items-center bg-slate-50 p-6 rounded-lg border border-slate-200 shadow-sm">
      ...
      <section id="education" className="py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-6 tracking-tight">EDUCATION</h2>
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-slate-200">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-slate-900">New York University</h3>
                  <p className="text-blue-600 font-semibold">Master of Management of Technology, Data Science</p>
                </div>
                <div className="text-sm text-slate-500 font-medium mt-2 md:mt-0">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-slate-200">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  <h3 className="text-2xl font-bold text-slate-900">University of Mumbai</h3>
                  <p className="text-blue-600 font-semibold">Bachelor of Technology, Mechanical Engineering</p>
                </div>
                <div className="text-sm text-slate-500 font-medium mt-2 md:mt-0">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col items-center space-y-8 max-w-md mx-auto">
            <div className="flex items-center">
              <Phone className="w-6 h-6 text-blue-500 mr-6" />
              <a 
            ...
            <div className="flex items-center">
              <Linkedin className="w-6 h-6 text-blue-500 mr-6" />
              <a 
            ...
            <div className="flex items-center">
              <Mail className="w-6 h-6 text-blue-500 mr-6" />
              <a 
            ...
            <div className="flex items-center">
              <Rocket className="w-6 h-6 text-blue-500 mr-6" />
              <span className="text-slate-300 font-medium">Brooklyn, New York, USA</span>
            </div>
          </div>
        </div>
      </section>
